...
// solidity verifier contract generated with groth16
content = fs.readFileSync("./contracts/Multiplier3Verifier.sol", {encoding: 'utf8'});
...
// solidity verifier contract generated with plonk
content = fs.readFileSync("./contracts/_plonkMultiplier3Verifier.sol", {encoding: 'utf8'});
bumped = content.replace(solidityRegex, 'pragma solidity ^0.8.0');
